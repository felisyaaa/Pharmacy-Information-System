...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="text" name="name" value="<?= $fetch_profile['name']; ?>" required placeholder="Masukkan nama pengguna" maxlength="20"  class="box" oninput="this.value = this.value.replace(/\s/g, '')">

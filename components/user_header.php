...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="home.php" class="logo">Sehat<span>Plus</span></a>
      ...
      <div class="profile">
         ...
         ?>
            ...
            <a href="components/user_logout.php" class="delete-btn" onclick="return confirm('Anda yakin ingin keluar dari website?');">Keluar</a>
         <?php
         } else {
         ?>
